...
# 53 "mcc_generated_files/uart/src/../../system/../capture/ccp1.h"
...
# 117 "mcc_generated_files/uart/src/../../system/../timer/tmr1.h"
void Timer1_StartSinglePulseAcquisition(void);
# 126 "mcc_generated_files/uart/src/../../system/../timer/tmr1.h"
...
# 161 "mcc_generated_files/uart/src/../../system/../timer/tmr1.h"
...
static volatile uint8_t eusart1RxBuffer[(128)];
static volatile eusart1_status_t eusart1RxStatusBuffer[(128)];
...
size_t EUSART1_ErrorGet(void)
{
    eusart1RxLastError.status = eusart1RxStatusBuffer[(eusart1RxTail + 1) & ((128) - 1)].status;
...
uint8_t EUSART1_Read(void)
{
    ...
    tempRxTail = (eusart1RxTail + 1) & ((128) - 1);
...
void EUSART1_ReceiveISR(void)
{
 ...
 uint8_t tempRxHead;
    ...
    tempRxHead = (eusart1RxHead + 1) & ((128) - 1);
